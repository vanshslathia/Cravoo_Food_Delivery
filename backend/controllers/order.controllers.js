        ...
        if (status == "out of delivery" && !shopOrder.assignment) {
            ...
            if (io) {
                availableBoys.forEach(boy => {
                    ...
                    console.log("newAssignment target:", { deliveryBoyId: boy._id, socketId: boySocketId })
                    if (boySocketId) {
                        console.log("emitting newAssignment:", { deliveryBoyId: boy._id, socketId: boySocketId, assignmentId: deliveryAssignment._id })
